...
int main() {
    ...
    std::vector<thrust::universal_host_pinned_vector<int>> h_matrices(NB_IMAGES, thrust::universal_host_pinned_vector<int>(MATRIX_SIZE, 4));
    std::vector<thrust::universal_host_pinned_vector<int>> h_medians(NB_IMAGES, thrust::universal_host_pinned_vector<int>(NB_TILE_X * NB_TILE_Y));
